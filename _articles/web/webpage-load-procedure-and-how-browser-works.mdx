...
description: 우리가 보는 사이트가 불러와지는 과정과 그 사이에서 브라우저는 어떻게 작동하는지에 대한 원리를 설명합니다.
---
...
![](/assets/articles/browser-detail.png)

### 유저 인터페이스(User Interface)

![](/assets/articles/browser-ui.png)브라우저에서 웹 페이지를 제외한 나머지, 사용자가 인터렉션 할 수 있는 영역
